...
const range = (N = 0, S = 0, r = []) => N === S? r : range(N, S + 1, [...r, S]);
...
const genGame = function(alphabet, numPegs, numTries) {
    ...
    const won = () => guess > 0? guesses[guess-1].result.every(e=>e===2):false;
    return {
	next: col => use(guesses[guess].pegs.findIndex(e=>e===0),idx => idx >= 0? guesses[guess].pegs[idx] = col : null),
	guesses:() => guesses,
...
console.log(randomElement(alphabet));
